...
export default function HomeScreen({navigation}: { navigation: any }) {
  ...
  return (
    <View>
      ...
      />
      <Button title="08 - Login"
              onPress={() =>
                navigation.navigate('08Login')
              }
      />
      <Button title="09 - Listing Edit"
              onPress={() =>
                navigation.navigate('09ListingEdit')
              }
      />
      <Button title="10 - Image Picker"
              onPress={() =>
                navigation.navigate('10ImagePicker')
              }
      />
      <Button title="11 - Listing Edit"
              onPress={() =>
                navigation.navigate('11ListingEdit')
              }
      />
